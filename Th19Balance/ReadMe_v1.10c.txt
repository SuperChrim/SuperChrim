...
For the purpose of this document, the following terms are equivalent:
...
Tsukasa:
 ...
 - Non spell bullet speed is decreased at lower levels
...
Chiyari:
 ...
 - Ex have no collision for first 30 frames after spawning
 - Ex disappear when bombed and after player death
 - Ex can be grazed
...
Ability Cards:
 ...
 - Biten's second card makes Yachie Ex otter spirits passable when disabled and decreases their collision size
 - Biten's second card makes otter spirits no longer shoot bullets
 - Enoko's second card makes Saki Ex wolf spirits passable when disabled and decreases their collision size
